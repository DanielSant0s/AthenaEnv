...
APP_CORE = main.o vif.o draw_3D.o draw_3D_notex.o draw_3D_lights.o draw_3D_lights_notex.o athena_math.o memory.o ee_tools.o module_system.o taskman.o pad.o system.o strUtils.o 
...
mpgs: src/draw_3D.vsm src/draw_3D_notex.vsm src/draw_3D_lights.vsm src/draw_3D_lights_notex.vsm
