...
APP_CORE = main.o vif.o draw_3D.o draw_3D_colors_no_math.o athena_math.o memory.o ee_tools.o module_system.o taskman.o pad.o system.o strUtils.o 
...
mpgs: src/draw_3D.vsm src/draw_3D_colors_no_math.vsm
