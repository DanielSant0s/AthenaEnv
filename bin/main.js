...
shapes.push(new Line(20.0, 20.0, 150.0, 448.0, Color.new(64, 0, 128)));
shapes.push(new Triangle(29.0, 96.0, 120.0, 10.0, 170, 150.0, Color.new(0, 128, 0)));
shapes.push(new Triangle(150.0, 20.0, 150.0, 100.0, 250.0, 150.0, Color.new(0, 128, 0), Color.new(128, 0, 0), Color.new(0, 0, 128)));
shapes.push(new Quad(550.0, 100.0, 350.0, 100.0, 420.0, 350.0, 220.0, 420.0, Color.new(0, 128, 0), Color.new(128, 0, 0), Color.new(0, 0, 128), Color.new(64, 0, 128)));
shapes.push(new Rect(200.0, 200.0, 50, 50, Color.new(255, 150, 0)));
shapes.push(new Circle(300.0, 300.0, 50, Color.new(128, 0, 255)));
...
for(var i = 0; i < 10000; i++){
    ...
    for(var shape = shapes[0], i = 0; i < shapes.length; i++, shape = shapes[i]){
        shape.draw();
    }
